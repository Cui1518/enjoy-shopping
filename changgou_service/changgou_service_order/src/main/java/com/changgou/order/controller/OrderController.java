...
public class OrderController {
     ...
     * @return
     */
    @PutMapping("/mergeOrder")
    public Result mergeOrder( @RequestParam Long zid, @RequestParam Long cid){
        orderService.mergeOrder(zid,cid);
        return new Result(true,StatusCode.OK,"合并订单成功");
    }
    ...
    public Result batchSend(@RequestBody List<Order> orders){
        ...
        return new Result(true,StatusCode.OK,"订单批量发货成功");
    }
